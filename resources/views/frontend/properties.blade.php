    ...
    <div class="container-fluid mt-4">
        <div class="row gx-4">
                    ...
                    <div class="filter-section">
                        ...
                        <form method="GET" action="{{ route('frontend.properties') }}" id="filter-form">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select form-select-sm" name="category_slug" id="categoryFilter" onchange="this.form.submit()">
                                ...
                                <select class="form-select form-select-sm" name="governorate_id" id="governorateFilter">
                                    ...
                                    @isset($governorates)
                                        @foreach ($governorates as $governorate)
                                            <option value="{{ $governorate->id }}" {{ request('governorate_id') == $governorate->id ? 'selected' : '' }} data-areas="{{ json_encode($governorate->areas->pluck('name', 'id')) }}">
                                                {{ $governorate->name }}
                                            </option>
                                        @endforeach
                                    @endisset
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-sm mb-1">
                                    ...
                                    <input type="number" name="min_price" class="form-control" min="0" placeholder="e.g., 50000" value="{{ request('min_price') }}">
                                </div>
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text">Max</span>
                                    <input type="number" name="max_price" class="form-control" min="0" placeholder="e.g., 500000" value="{{ request('max_price') }}">
                                </div>
                            </div>
            ...
            @else
                ...
                <div class="col-lg-12"> {{-- عمود النتائج للزائر يأخذ العرض الكامل --}}
                    <div class="alert alert-info text-center">
                        ...
                        <a href="{{ route('login') }}" class="alert-link">Log in</a> or <a href="{{ route('register') }}" class="alert-link">create an account</a> to access advanced search filters!
                    </div>
            @endif
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 pb-2 border-bottom">
                <h5 class="mb-0">Showing {{ $properties->firstItem() ?? 0 }}-{{ $properties->lastItem() ?? 0 }} of {{ $properties->total() }} Properties</h5>
            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                        <div class="card property-card h-100 shadow-sm">
                            ...
                            <div class="card-body d-flex flex-column">
                                <h5 class="card-title fw-bold text-primary mb-1">{{ $property->currency ?? 'USD' }} {{ number_format($property->price, 0) }}
