...
@section('content')
    <div class="container-fluid mt-4">
      ...
      <div class="d-md-none p-2">
        <button class="btn btn-outline-gold" type="button" data-bs-toggle="offcanvas" data-bs-target="#sidebarOffcanvas1" aria-controls="sidebarOffcanvas1">
          filter <i class="bi bi-funnel "></i>
        </button>
      </div>
        <!-- Offcanvas للهواتف -->
      <div class="offcanvas offcanvas-start d-md-none" tabindex="-1" id="sidebarOffcanvas1" aria-labelledby="sidebarOffcanvasLabel1">
        <div class="offcanvas-header">
          
          <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
                <div class="col-lg-3 col-md-4">
                    <div class="filter-section offcanvas-body">
