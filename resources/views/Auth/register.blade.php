...
<head>
  ...
  <style>
    ...
    .logo { font-size: 2.5rem; font-weight: bold; color: #f1c40f; display: flex; align-items: center; justify-content: center; height: 100vh; }
    .form-container { max-width: 400px; margin: auto; padding: 2rem; border-radius: 1rem; box-shadow: 0 0 10px rgba(0,0,0,0.1); }
...
<div class="container-fluid">
  <div class="row min-vh-100">
    ...
    <div class="col-md-6 d-none d-md-flex logo flex-column">
      <div>
        {{-- ↓↓↓ تم التعديل باستخدام asset() ↓↓↓ --}}
        <img src="{{ asset('frontend/assets/شعار مفرغ 2 1 (1).png') }}" alt="Easy Find" style="max-width: 600px;">
      </div>
    </div>
    ...
    <div class="col-md-5 d-flex align-items-center justify-content-center">
      <div class="form-container bg-white">
        ...
        <div class="d-flex justify-content-between mb-3">
          <button type="button" class="btn btn-light w-100 me-2" disabled title="Coming soon!"> {{-- Added disabled & title --}}
            <img src="https://img.icons8.com/color/16/google-logo.png"/> Sign up with Google
          </button>
          <button type="button" class="btn btn-light w-100 ms-2" disabled title="Coming soon!"> {{-- Added disabled & title --}}
        ...
        <form method="POST" action="{{ route('register.post') }}" novalidate>
            ...
            <div class="mb-2">
                 {{-- ↓↓↓ إضافة name, old(), @error, is-invalid ↓↓↓ --}}
                <input type="tel" class="form-control @error('phone') is-invalid @enderror" placeholder="Phone number (Optional)"
            ...
            <div class="form-check mb-3">
                ...
                <input type="checkbox" class="form-check-input @error('terms') is-invalid @enderror" id="terms"
                       name="terms" value="1" {{ old('terms') ? 'checked' : '' }}>
