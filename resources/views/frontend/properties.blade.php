...
@section('description',
    'Browse all available properties for sale and rent in Gaza. Filter by location, type, price, and
    more.')
        ...
        <div class="row gx-4">
            ...
            <div class="col-lg-9 col-md-8">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3 pb-2 border-bottom">
                    <h5 class="mb-0">Showing {{ $properties->firstItem() }}-{{ $properties->lastItem() }} of
                ...
                <div class="row property-list-row" id="propertiesList">
                    ...
                    @empty
                        <div class="col-12 d-flex justify-content-center align-items-center" style="min-height: 400px;">
                            <div class="alert alert-light text-center p-4 p-md-5 border rounded-3 shadow-sm"
