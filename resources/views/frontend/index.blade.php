...
@section('description', 'Find properties for sale or rent in Gaza. EasyFind helps you locate houses, apartments, tents, and caravans.')
@section('content')
    {{-- Carousel --}}
    <div id="carouselExampleCaptions" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{ asset('frontend/assets/better_cropped_villa.png') }}" class="d-block w-100" alt="...">
                <div class="container">
                    <div class="carousel-caption text-start">
                        <h1 style="color: black;"><span class="highlighted-word">Buy </span></h1>
                        <p style="color: black;"><span class="highlighted-word">All you want in real estate will find it here </span></p>
                        <form class="d-flex" role="search" method="GET" action="{{ route('frontend.properties') }}">
                            <input style="width: 400px;" class="form-control me-2" type="search" name="search" placeholder="Search by title, address..." aria-label="Search" value="{{ request('search') }}">
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption">
                    ...
                    <p>Showcase your property to thousands of potential buyers.</p>
                     ...
                     @else
                          <p><a class="btn btn-lg btn-outline-light" href="{{ route('login') }}?redirect={{ urlencode(route('lister.properties.create')) }}">Login to Sell</a></p>
                     @endcan
                </div>
            </div>
            <div class="carousel-item">
                <img src="{{ asset('frontend/assets/cropped_A_high-resolution_digital_photograph_showcases_a_s.png') }}" class="d-block w-100" alt="...">
                <div class="carousel-caption text-start">
                    <h1 style=" color: black;"><span style="color: black;" class="highlighted-word">Rent</span></h1>
                    <p style="color: black;" class="opacity-75"><span class="highlighted-word">Helping millions find their perfect rental fit.</span></p>
                    <p><a class="btn btn-lg btn-outline-gold" href="{{ route('frontend.properties', ['purpose' => 'rent']) }}">View Rentals</a></p>
                </div>
            </div>
        </div>
    ...
    {{-- قسم What's happening --}}
    <div class="px-4 py-5 my-5 text-center">
        <h1 class="display-5 fw-bold text-body-emphasis">What's happening in your area</h1>
        <div class="col-lg-6 mx-auto">
            <p class="lead mb-4">Whether you're in search of a new residence, an investment opportunity, or simply exploring the area, we are here to assist you in discovering precisely what meets your needs.</p>
         ...
         <div class="row g-4">
            <div class="col-md-3 col-sm-6">
                <div class="card-stat card-dark">
                    <div class="stat-number">{{ App\Models\Property::where('status', 'approved')->where('purpose', 'rent')->count() }}+</div>
                    <div class="stat-text">Homes For Rent</div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="card-stat card-light">
                    <div class="stat-number">{{ App\Models\Property::where('status', 'approved')->where('purpose', 'sale')->count() }}+</div>
                    <div class="stat-text">Homes For Sale</div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="card-stat card-dark">
                     <div class="stat-number">{{ App\Models\User::where('role', 'property_lister')->where('status', 'active')->count() }}</div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="card-stat card-light">
                     ...
                     <div class="stat-number">{{ App\Models\Property::where('status', 'approved')->whereHas('category', fn($q) => $q->where('slug', 'apartment'))->count() }}+</div>
    ...
    <div class="container py-4">
         <div class="row text-center justify-content-center g-4">
            <div class="col-6 col-md-3 col-lg-1">
                <a href="{{ route('frontend.properties', ['category_slug' => 'house']) }}" class="text-decoration-none filter-item-link">
                    <div class="filter-item {{ request('category_slug') == 'house' ? 'active' : '' }}"> {{-- جعل active ديناميكي --}}
             ...
             <div class="col-6 col-md-3 col-lg-1">
                 <a href="{{ route('frontend.properties', ['category_slug' => 'apartment']) }}" class="text-decoration-none filter-item-link">
            ...
            <div class="col-6 col-md-3 col-lg-1">
                 <a href="{{ route('frontend.properties', ['category_slug' => 'caravan']) }}" class="text-decoration-none filter-item-link">
             ...
             <div class="col-6 col-md-3 col-lg-1">
                <a href="{{ route('frontend.properties', ['category_slug' => 'tent']) }}" class="text-decoration-none filter-item-link">
    ...
    <div class="container py-4">
        ...
        <div class="row g-4 property-list-row">
            ...
            <div class="col-12 d-flex justify-content-center">
                ...
                <div class="alert alert-light text-center p-4 p-md-5 border alert-no-properties rounded-3" role="alert" style="max-width: 600px; width: 100%;">
        ...
        <div class="text-center mt-5">
             <a href="{{ route('frontend.properties') }}" class="btn btn-outline-dark px-5 py-2 rounded-pill shadow-sm">View All Properties</a> {{-- تفعيل الرابط --}}
        </div>
    </div>
    ...
    <div class="container my-5">
         <div class="bg-dark text-white rounded-4 p-5 text-center">
            ...
            <form class="d-flex justify-content-center mt-4" style="max-width: 500px; margin: auto;" method="POST" action="#"> {{-- إضافة action لاحقاً --}}
                 @csrf
                <input type="email" name="email" class="form-control rounded-start-pill" placeholder="Enter email address" required>
    ...
    @push('scripts')
    <script>
        // Favorite icon toggle (visual only - needs backend logic)
        document.querySelectorAll('.favorite-icon').forEach(icon => {
            icon.addEventListener('click', function(event) {
                ...
                heart.classList.toggle('is-favorite', isFavorite); // Optional class for styling
                console.log(`Toggled favorite for property ${propertyId}. Is favorite: ${isFavorite}`);
                // Add AJAX call here
            });
        });
    </script>
